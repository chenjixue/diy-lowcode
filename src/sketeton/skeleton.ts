import {IWidget, Area} from "@/sketeton/area.ts"
import {isValidElement} from 'react';
import {WidgetContainer} from "./widget-container.ts";
import {IPublicTypeSkeletonConfig, IPublicTypeWidgetBaseConfig} from "../types";
import {PanelDock} from "./widget/panel-dock.ts";
import {Dock} from "./widget/dock.ts";
import {isPanel, Panel} from "./widget/pane.ts";
import {action, makeObservable} from "mobx";
import {Widget, WidgetConfig} from "@/sketeton/widget/widget.ts";
...
export class Skeleton {
    ...
    createContainer<T extends IWidget>(name: string, handle: (item: T) => T, exclusive = false, checkVisible: () => boolean = () => true, defaultSetCurrent = false) {
