...
import './style.less';
import {createSettingFieldView} from "@/sketeton/component/settings-pane/settings-pane.tsx";
 ...
 * @param value
 */
function onItemChange(target: any, index: number, item: any, props: ArraySetterProps) {
