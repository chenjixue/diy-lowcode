...
import {setters} from "@/entry/entry.ts";
import {computed, observable} from "mobx";
import {Title} from "@/sketeton/component/title/index.tsx"
...
function nomalizeSetters(
    ...
    if (!setters) {
        ...
        this.settersMap.forEach((setter, name) => {
            if (name === 'MixedSetter') {
                return;
            }
            normalized.push({
...
export default class MixedSetter extends Component<{
    ...
    @observable.ref private used?: string;
