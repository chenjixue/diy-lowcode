import {isPanel} from "./widget/pane.ts";
...
export class WidgetContainer<T extends WidgetItem = any> {
    ...
    constructor(readonly name: string, private handle: (item: T) => T, private exclusive: boolean = false, private checkVisible: () => boolean = () => true, private defaultSetCurrent: boolean = false) {
        makeObservable(this)
    }
