import {getPublicPath} from "@/util/get-public-path.ts";
import {createSimulator} from "@/host/create-simulator.ts";
import {AssetLevel, AssetType, IPublicTypeComponentInstance} from "../types";
import {autorun, IReactionOptions, IReactionPublic, observable} from "mobx"
import {assetItem} from "@/util/asset.ts";
import "./host.less"
...
export class BuiltinSimulatorHost {
    ...
    setupDragAndClick() {
        ...
        doc.addEventListener(
            'mousedown', (downEvent: MouseEvent) => {
                const documentModel = this.project.currentDocument as DocumentModel;
     ...
     */
    connect(
        renderer: SimulatorRendererContainer,
