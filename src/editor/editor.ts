import {AssetLoader} from '@/util/asset.ts';
import {engineConfig} from '@/plugin-manager/plugin-manager.ts';
import {observable} from "mobx";
import {EventBus} from "@/editor/event-bus.ts";
                ...
                await Promise.all(
                    remoteComponentDescriptions.map(async (component: IPublicTypeRemoteComponentDescription) => {
                        ...
                        function setAssetsComponent(component: any, extraNpmInfo: any = {}) {
                            ...
                            // console.log(JSON.parse(JSON.stringify(components)), "AssetsComponents")
